...
The rule, its thresholds and the reasons they are what they are live in `glyph_atlas.ainu`; this
script is the report over a dataset — how many pages' column counts match their transcribed line
counts, witness by witness.
...
from glyph_atlas import ainu, detect, images, tables
