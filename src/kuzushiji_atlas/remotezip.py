...
CACHE_URL = b"kuzushiji-atlas.url"
CACHE_ETAG = b"kuzushiji-atlas.etag"
CACHE_SIZE = b"kuzushiji-atlas.size"
CACHE_DIRECTORY_SIZE = b"kuzushiji-atlas.central-directory-size"
