...
def datasheet(figures: Figures, template: Path | None = None) -> str:
    ...
    return (
        "# Datasheet\n\n"
        f"Release {figures.version} of Kuzushiji Atlas, built {figures.date} with "
...
def zenodo_metadata(figures: Figures) -> dict[str, Any]:
    ...
    return {
        "metadata": {
            "title": "Kuzushiji Atlas: character-shape dataset of pre-modern Japanese writing",
            "upload_type": "dataset",
            ...
            "related_identifiers": [
                {"identifier": "https://github.com/mkpoli/kuzushiji-atlas", "relation": "isSupplementTo",
