...
The cache directory is `cache/images` of the repository, or `$GLYPH_ATLAS_CACHE/images`, or the
...
def cache_root() -> Path:
    """The directory that holds `images/`: `$GLYPH_ATLAS_CACHE`, or `cache/` of the repository."""
...
def images_root(root: Path | None = None) -> Path:
    """The image cache directory: `root`, or `$GLYPH_ATLAS_CACHE/images`, or `cache/images`."""
