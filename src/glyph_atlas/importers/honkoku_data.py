...
#: `src/glyph_atlas/importers/honkoku_data.py` sits three directories below the repository root.
...
def import_all(
    ...
    *,
    ...
    directory that holds `manifests/`, `$GLYPH_ATLAS_CACHE` by default. The tables hold one
