...
try {
  ...
  await browser.goto(`${service.base}/#/explore`, { waitFor: `document.querySelector('.glyph-tile .glyph-image')?.naturalWidth > 0` })
  ...
  await browser.goto(`${service.base}/#/explore`, { waitFor: `document.querySelector('.glyph-tile') !== null` })
  ...
  await browser.evaluate(`location.hash = '#/character/' + encodeURIComponent(${JSON.stringify(unit)})`)
