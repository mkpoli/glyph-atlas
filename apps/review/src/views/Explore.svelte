...
<section class="explore">
  ...
  <div class="collection-bottom"><span>KUZUSHIJI ATLAS</span><span>{number(data?.counts.checked)} checked <span class="separator">·</span> {number(data?.counts.flagged)} flagged</span></div>
</section>
