...
-- Decisions are only ever added; a republished clustering replays them all, in rowid order within
-- one second, onto its new rows.
CREATE TABLE IF NOT EXISTS form_decisions (
 id TEXT PRIMARY KEY, at TEXT NOT NULL, actor TEXT NOT NULL, kind TEXT NOT NULL, family TEXT NOT NULL,
 form TEXT, cluster TEXT, revision TEXT NOT NULL, units TEXT NOT NULL, note TEXT NOT NULL
);
