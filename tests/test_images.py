...
The cache is pointed at `tmp_path` through `KUZUSHIJI_ATLAS_CACHE`, and every request goes to the
`http_server` fixture.
"""
...
from kuzushiji_atlas import images, net, tables
from kuzushiji_atlas.schema import Box, Page, Unit
