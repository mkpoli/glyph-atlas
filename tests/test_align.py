...
from glyph_atlas.schema import Box, Line, ReviewState, UnitKind
...
def test_run_directory_writes_only_its_own_units(tmp_path, monkeypatch):
    ...
    from glyph_atlas import align, images, koji, tables
    ...
    with monkeypatch.context() as patched:
        patched.setenv("GLYPH_ATLAS_CACHE", str(tmp_path / "cache"))
...
def test_ruby_is_recorded_without_a_box():
    ...
    from glyph_atlas.schema import Box, Line, ReviewState
