"""Tests for `glyph_atlas.review.corrections`, the page-transcription correction layer.
...
from glyph_atlas import ainu_source, tables
from glyph_atlas.review import corrections as corrections_module
from glyph_atlas.review.corrections import Correction, CorrectionError
from glyph_atlas.review.store import Store
from glyph_atlas.schema import Document, Line, Page, PageText
...
def test_a_correction_survives_reopening_applying_and_replaying(dataset: Path) -> None:
    ...
    from glyph_atlas.review import store as store_module
