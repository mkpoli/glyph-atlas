...
from kuzushiji_atlas import refs, tables
from kuzushiji_atlas.review import corpus_source
from kuzushiji_atlas.review.characters import Layers
from kuzushiji_atlas.review.server import create_app
from kuzushiji_atlas.review.store import ReviewRequest, Store
from kuzushiji_atlas.schema import Box, Document, Line, Page, Unit, VariantRef
...
def test_the_real_corpus_package_answers_the_same_shape(dataset):
    ...
    """
    pytest.importorskip("kuzushiji_atlas.corpus.api")
    from kuzushiji_atlas.corpus.api import CorpusAPI
...
def test_layer_rebuild_reuses_page_lookups_and_refreshes_missing_images(dataset, monkeypatch):
    from kuzushiji_atlas.review.characters import Layers
    from kuzushiji_atlas.review.server import cached_image
...
def test_layer_fallback_checks_image_index_once_per_rebuild(dataset, monkeypatch):
    ...
    from kuzushiji_atlas.review import characters
...
def test_visual_group_preview_serves_only_registry_samples(dataset, tmp_path, monkeypatch):
    from kuzushiji_atlas import visual_families
