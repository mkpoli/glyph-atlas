...
from kuzushiji_atlas.importers import codh
from kuzushiji_atlas.schema import Script, UnitKind
...
def test_codh_rows_become_pages_and_units(tmp_path):
    ...
    assert units[0].script is Script.HIRAGANA and units[0].jibo is None
