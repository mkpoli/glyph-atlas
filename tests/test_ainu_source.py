"""Tests for `glyph_atlas.ainu_source`, the bridge to the publishing project.
...
from glyph_atlas import ainu_source
from glyph_atlas.ainu_source import AinuSource, AinuSourceError, Proposal
