...
from kuzushiji_atlas import reconcile, rights, tables
from kuzushiji_atlas.schema import Box, Document, Licence, Line, Page, Rights, Unit
...
def test_resolve_rewrites_the_documents_table_and_its_manifest(tmp_path):
    ...
    (directory / "MANIFEST.json").write_text(
        json.dumps({"schema_version": 1, "tables": {"documents": 1}, "files": {"documents.parquet": "old"},
                    "writer": "kuzushiji-atlas 0.0.1", "command": "atlas import honkoku-lines",
