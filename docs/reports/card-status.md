...
| T22 classifier | running | manifests and crops built on the full tables; 12 epochs on the card, five done. Val top-1 0.934 and top-5 0.989 at epoch 9 of 12, against the card's targets of 0.93 and 0.99: the top-1 side is met and the top-5 side is within a tenth of a point, with the best checkpoint still moving; calibration and the test split follow |
