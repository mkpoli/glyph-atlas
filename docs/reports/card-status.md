...
| T22 classifier | running | manifests and crops built on the full tables; 12 epochs on the card, five done. Epoch 10 of 12 at val top-1 0.933 and top-5 0.988, against the card's targets of 0.93 and 0.99: the top-1 side is met across epochs 8 to 10 and the top-5 side sits about two tenths of a point under. One epoch, then the temperature calibration and the test split, follows |
