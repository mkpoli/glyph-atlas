...
| T22 classifier | running | manifests and crops built on the full tables; 12 epochs on the card, five done. Val top-1 0.931 and top-5 0.990 at epoch 8 of 12, against the card's targets of 0.93 and 0.99, so the top-1 side is met and the top-5 side is close; calibration and the test split follow |
