...
is the pair `kuzushiji_atlas.classify.Classifier` reads, and a crop is always 96 square, so the batch
...
while T20's val books are still being imported. `--base` exports the untrained backbone, which is
...
from kuzushiji_atlas import classify
